#
#  Be sure to run `pod spec lint CustomPopoverView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/maltsugar/CustomPopoverView.git", :tag => "#{spec.version}" }
